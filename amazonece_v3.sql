...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 02 mai 2019 à 13:44
...
INSERT INTO `acheteurs` (`Login`, `Nom`, `Prenom`, `Email`, `Mdp`, `Photo`, `Num`, `Adresse`, `Adressebis`, `Ville`, `Pays`, `CP`, `Carte`, `NumCarte`, `NomCarte`, `DateExpiM`, `DateExpiA`, `CodeSecu`, `Téléphone`) VALUES
(11111, 'Vista', 'Astala', 'astalavista@gmail.com', 'bip01', 'http://ekladata.com/FYaT3Oi0PROnXcetYyEqjj08s98@550x398.png', 601234567, '1 rue Terminator 38569 Combles sur Terre', 'Batiment jugement dernier', 'Paris', 'Frabce', 76016, 'Mastercard', 26584151, 'Alice Borie', 2, 22, 356, 0632652536),
(22222, 'Crustace', 'Coquillage', 'coqui@gmail.com', 'bip02', 'http://ekladata.com/NJvtYpLbTWgs0O1YbZWXQdK-iLI@100x149.png', 345678901, '20 boulevard Sable Caraibes', '', 'Marseille', 'France', 13006, 'Visa', 26878922, 'Crustace Coquillage', 3, 26, 565, 0625459871),
(33333, 'Hilton', 'Paris', 'parishilton@gmail.com', 'bip03', 'http://ekladata.com/ffflXL7K1ObLD-EG21DBZv1V0As@350x506.png', 234567890, '', '', '', '', 0, 'Visa ', 323265563, 'Paris Hilton', 11, 26, 456, 0652585768),
(44444, 'Gami', 'Shini', 'shinigami@gmail.com', 'bip04', 'http://ekladata.com/1-kXGcG3M39n3KP6yQ2A9_r2SlY@350x341.png', 876543212, '8 avenue des Cieux ', '', 'Saint-Michel', 'Paradis', 13001, 'American Express', 0, 'Gaetan Lajeune', 11, 26, 111, 0145253656),
(55555, 'Ben', 'Benjamin', 'ben@gmail.com', 'bip05', 'http://ekladata.com/sjHdj9qwA0oYDUetpUb6Vlpf30k@350x590.png', 987654567, '87 rue des ascenseurs  ', 'Hotel de ville', 'Tokyo', 'Japon', 28777, 'Visa', 236598, 'Romeo Benjamin ', 2, 22, 666, 0678561214);
