...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 02 mai 2019 à 18:54
...
INSERT INTO `acheteurs` (`ID`, `Nom`, `Prenom`, `Email`, `Mdp`, `Adresse`, `Adressebis`, `Ville`, `Pays`, `CP`, `Carte`, `NumCarte`, `NomCarte`, `DateExpiM`, `DateExpiA`, `CodeSecu`, `Telephone`) VALUES
(11111, 'OK', 'Manir', 'lolo.lapin@gmail.com', 'bip01', '1 rue du peuplier', '', 'Paris', 'Fiji', 78180, 'Visa', 26584151, 'LOLO', 07, 2024, 113, 0652585768),
(22222, 'Crustace', 'Coquillage', 'coqui@gmail.com', 'bip02', '20 boulevard Sable Caraibes', '', 'Marseille', 'France', 13006, 'Visa', 26878922, 'Crustace Coquillage', 03, 2026, 565, 0625459871),
(33333, 'Hilton', 'Paris', 'parishilton@gmail.com', 'bip03', '', '', '', '', 0, 'Visa ', 323265563, 'Paris Hilton', 11, 2026, 456, 0652585768),
(44444, 'Gami', 'Shini', 'shinigami@gmail.com', 'bip04', '8 avenue des Cieux ', '', 'Saint-Michel', 'Paradis', 13001, 'American Express', 0, 'Gaetan Lajeune', 11, 2026, 111, 0145253656),
(55555, 'Ben', 'Benjamin', 'ben@gmail.com', 'bip05', '87 rue des ascenseurs  ', 'Hotel de ville', 'Tokyo', 'Japon', 28777, 'Visa', 236598, 'Romeo Benjamin ', 02, 2022, 666, 0678561214);
...
INSERT INTO `vendeurs` (`ID`, `Nom`, `Prenom`, `Photo`, `ImgFond`, `Nbitems`, `Email`) VALUES
