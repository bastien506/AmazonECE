...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 05 mai 2019 à 10:21
...
(3510, 'paul watzlawick ', 'comment reussir a echouer ', 'essais', '2005-05-05', 'psychologie', '', 'anglais', 'vous en avez d echouer a echouer vos objectifs ? grace a ce petit guide la reussite de vos echecs devient possible ! ', 7, 1, 1, 1, 1, 5, 'imgarticle/Livres/reussiraechouer.jpg', 2001),
...
(3313, 'Orwell', '1984', 'pocket jeunesse', '2001-01-01', 'science fiction', '', 'anglais', 'une dystopie', 15, 1, 1, 1, 1, 2, 'imgarticle/Livres/1984.jpg', 2001);
...
(4002, 'Black Sabbath', 'Black Sabbath', 'Black Sabbath', 'Metal', '1970-01-01', 'Vinyle', 'Black Sabbath', 'Fondateur du metal.\r\nI am Iron Man!!', 35, 1, 'imgarticle/Musiques/black_sabbath.jpg', 2002, 'vidarticle/Musiques/blacksab.mp4'),
(4003, 'Best Of Celine Dion (Coffret)', 'Celine Dion', 'Celine Dion', 'Musique française', '2009-11-23', 'CD', 'Best Of Celine Dion (Coffret)', 'L\'une des plus belle voix qui existe.', 14.99, 0, 'imgarticle/Musiques/bestofcelinedion.jpg', 2003, ''),
(4004, 'Shanking Shoes', 'Naaman', 'Naaman', 'Reggae', '2013-06-21', 'Telechargement', 'Deep Rockers: Back a Yard', 'Skanking Shoes est le premier hit de Naaman et sans doute son plus gros à ce jour. En 2012, un jeune Normand débarque de nulle part et prend tout le monde de court avec une mixtape qui se propage comme une traînee de poudre dans l\'Hexagone. Deep Rockers regroupe dix titres produits par Fatbabs essentiellement à base de samples. Celui de Skanking Shoes, cest le titre Children of the Ghetto de la chanteuse Senya.', 1, 9, 'imgarticle/Musiques/naaman.jpg', 2004, 'vidarticle/Musiques/shanking.mp4'),
(4005, 'Hair of the dog ', 'Nazareth ', 'Nazareth ', 'Heavy Metal ', '1975-04-05', 'Telechargement', 'Hair of the dog ', 'Hair of the Dog est le sixieme album studio du groupe écossais Nazareth, sorti le 05 avril 1975.', 6.99, 3, 'imgarticle/Musiques/hairofthedog.jpg', 2005, 'vidarticle/Musiques/hairofthedog.mp4'),
(4006, ' Romeo et Juliette, de la haine a l amour ', 'Damien Sargue', 'Damien Sargue', 'Comedie musical ', '2010-01-05', 'CD', 'Romeo et Juliette, de la haine a l amour', 'Album regroupant les chansons de la comedie musicale \" Romeo et Juliette, de la haine a l amour \"', 40.02, 1, 'imgarticle/Musiques/romeo&juliette.jpg', 2002, 'vidarticle/Musiques/romeo.mp4'),
...
(4739, 'fatal bazooka ta vu ?', 'fatal bazooka', 'fatal bazooka', 'rap ', '2003-05-01', 'cd', 'ta vu ?', 'album avec le mythique fous ta cagoule du grand rappeur fatal ', 20, 1, 'imgarticle/Musiques/fatal.jpg', 2003, 'vidarticle/Musiques/fatal.mp4'),
(4877, 'carmen vinyle', 'georges bizet', 'georges bizet', 'classique ', '1875-03-01', 'vinyle', 'carmen', 'le celebre opera de bizet sur un support vinyle ', 20, 10, 'imgarticle/Musiques/carmen.jpg', 2003, 'vidarticle/Musiques/carmen.mp4'),
(4430, 'manau - la tribu', 'MANAU', 'MANAU', 'RAP', '1998-01-01', 'telechargement', 'la tribu ', 'rap breton. vive la bretagne', 1, 1, 'imgarticle/Musiques/latribudedana.jpg', 2001, 'vidarticle/Musiques/manau.mp4'),
(4656, 'i am le mia ', 'IAM', 'iam', 'rap', '1993-01-01', 'cd', 'ombre est lumiere', 'je danse le mia ', 15, 10, 'imgarticle/Musiques/ombre.jpg', 2003, 'vidarticle/Musiques/mia.mp4'),
(4968, 'reefer madness ', 'ghostlight', 'ghoslit records', 'comedie musicale', '2005-01-01', 'telechargement', 'reefer madness ost', 'comedie musicale sur les dangers du cannabis ', 1, 1, 'imgarticle/Musiques/reefermadnessjpg.jpg', 2001, 'vidarticle/Musiques/reefermadness.mp4');
...
(6001, 'des abdos en beton avant l etre grace a notre produit ', 'Roue abdominale', 16, 'Adidas', 'Year-round', 1, 14.5, 7, 'imgarticle/Sports/ROUEADBO.jpg', 2001, ''),
(6002, 'parfait pour surveiller sa forme', 'Podometre', 16, 'HETP', 'ALL', 20, 60, 2, 'imgarticle/Sports/montreconnectee.jpg', 2002, ''),
(6484, 'une balle officielle pour jouer au baseball', 'balle baseball', 7, 'casal sport', 'ete', 1, 15, 30, 'imgarticle/Sports/balle.jpg', 2001, ''),
(6699, 'set parfait pour un debutant', 'haltere 10 kilos', 22, 'domyos', 'all', 12, 18, 7, 'imgarticle/Sports/halterejpg.jpg', 2003, ''),
(6910, 'de quoi travailler bras le dos et les abdos ! parfait pour la plage', 'training station 9000', 20, 'domyos', 'ete', 100, 175, 2, 'imgarticle/Sports/training.jpg', 2004, 'vidarticle/Sports/trainingstation.mp4'),
(6609, 'cette batte en aluminium est parfaite pour jouer.', 'superbe batte de baseball', 5, 'casal sport', 'printemps ', 2, 30, 9, 'imgarticle/Sports/batte.jpg', 2003, ''),
(6606, 'superbe ballon de basket adidas ', 'ballon de basket', 3, 'adidas', 'all', 2, 8, 7, 'imgarticle/Sports/basket.jpg', 2005, '');
