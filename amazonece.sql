...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 01 mai 2019 à 11:46
...
INSERT INTO `acheteurs` (`Login`, `Nom`, `Prenom`, `Email`, `Mdp`, `Photo`, `Num`, `Adresse`, `Adressebis`, `Ville`, `Pays`, `CP`) VALUES
(11111, 'Vista', 'Astala', 'astalavista@gmail.com', 'bip01', 'http://ekladata.com/FYaT3Oi0PROnXcetYyEqjj08s98@550x398.png', 601234567, '1 rue Terminator 38569 Combles sur Terre', 'Batiment jugement dernier', 'Paris', 'Frabce', 76016),
(22222, 'Crustace', 'Coquillage', 'coqui@gmail.com', 'bip02', 'http://ekladata.com/NJvtYpLbTWgs0O1YbZWXQdK-iLI@100x149.png', 345678901, '20 boulevard Sable Caraibes', '', 'Marseille', 'France', 13006),
(33333, 'Hilton', 'Paris', 'parishilton@gmail.com', 'bip03', 'http://ekladata.com/ffflXL7K1ObLD-EG21DBZv1V0As@350x506.png', 234567890, '', '', '', '', 0),
(44444, 'Gami', 'Shini', 'shinigami@gmail.com', 'bip04', 'http://ekladata.com/1-kXGcG3M39n3KP6yQ2A9_r2SlY@350x341.png', 876543212, '8 avenur des Cieux ', '', 'Saint-Michel', 'Paradis', 13001),
(55555, 'Ben', 'Benjamin', 'ben@gmail.com', 'bip05', 'http://ekladata.com/sjHdj9qwA0oYDUetpUb6Vlpf30k@350x590.png', 987654567, '87 rue des ascenseurs  ', 'Hotel de ville', 'Tokyo', 'Japon', 28777);
