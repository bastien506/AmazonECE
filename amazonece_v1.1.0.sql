...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  sam. 04 mai 2019 à 09:28
...
(11111, 'Amour', 'Bisous', 'bizous@gmail.com', 'bip01', '1 rue du peuplier', '', 'Paris', 'Fiji', 78180, 'Visa', 26584151, 'LOLO', 07, 2024, 113, 0652585768, 'pp454153@gmail.com', 'monpaypal'),
(22222, 'Crustace', 'Coquillage', 'coqui@gmail.com', 'bip02', '20 boulevard Sable Caraibes', '', 'Marseille', 'France', 13006, 'Visa', 26878922, 'Crustace Coquillage', 03, 2026, 565, 0625459871, 'fofodl45@gmail.com', 'modzdz876'),
(33333, 'Hilton', 'Paris', 'parishilton@gmail.com', 'bip03', '', '', '', '', 0, 'Visa ', 323265563, 'Paris Hilton', 11, 2026, 456, 0652585768, 'efre@gmail.com', 'david78945'),
(44444, 'Gami', 'Shini', 'shinigami@gmail.com', 'bip04', '8 avenue des Cieux ', '', 'Saint-Michel', 'Paradis', 13001, 'American Express', 0, 'Gaetan Lajeune', 11, 2026, 111, 0145253656, 'kokko@@gmail.com', 'mlpozkods564'),
(122222, 'benji ', 'Benjamin', 'bonjour@hotmail.com', 'bip05', '87 rue des ascenseurs   mdifier', 'Hotel de ville', 'Tokyo', 'Japon', 28777, 'Visa', 236598, 'Romeo Benjamin ', 02, 2022, 666, 0678561214, 'momoeof@gmail.com', 'momo756664'),
(17750, 'Loganesque', 'Max', 'maxi@gmail.com', 'maxime', 'momo', '', 'Paris', 'France', 75000, '', 0, '', 00, 0, 0, 0658576954, '', '');
...
INSERT INTO `musiques` (`ID`, `Titre`, `Artiste`, `Compositeur`, `Style`, `Annee`, `Support`, `Album`, `Description`, `Prix`, `Quantite`, `Image`) VALUES
(11, 'Stupeflip', 'Stupeflip', 'Stupeflip', 'Punk, Rock, Rap', '2003-05-24', 'CD', 'Stupeflip', 'Premiere ere du stup.', 8.7, 0, 'imgarticle\\Musiques\\stupeflip.jpeg.jpg'),
(12, 'Black Sabbath', 'Black Sabbath', 'Black Sabbath', 'Metal', '1970-01-01', 'Vinyle', 'Black Sabbath', 'Fondateur du metal.\r\nI am Iron Man!!', 35, 0, 'imgarticle\\Musiques\\black_sabbath.jpg'),
(13, 'Best Of Celine Dion (Coffret)', 'Celine Dion', 'Celine Dion', 'Musique française', '2009-11-23', 'CD', 'Best Of Celine Dion (Coffret)', 'L\'une des plus belle voix qui existe.', 14.99, 10, 'imgarticle\\Musiques\\bestofcelinedion.jpg'),
...
(15, 'Hair of the dog ', 'Nazareth ', 'Nazareth ', 'Heavy Metal ', '1975-04-05', 'Telechargement', 'Hair of the dog ', 'Hair of the Dog est le sixieme album studio du groupe écossais Nazareth, sorti le 05 avril 1975.', 6.99, 3, 'imgarticle\\Musiques\\hairofthedog.jpg'),
(16, ' Romeo et Juliette, de la haine a l amour ', 'Damien Sargue', 'Damien Sargue', 'Comedie musical ', '2010-01-05', 'CD', 'Romeo et Juliette, de la haine a l amour', 'Album regroupant les chansons de la comedie musicale \" Romeo et Juliette, de la haine a l amour \"', 40.02, 1, 'imgarticle\\Musiques\\romeo&juliette.jpg'),
...
(18, 'Through the Fire and Flames', 'Dragon Force ', 'Dragon Force ', 'Extreme power metal  ', '2003-06-08', 'Telechargement', 'Inhuman Rampage ', 'Cette chanson figure dans le jeu vidéo Guitar Hero III: Legends of Rock : elle est consideree comme l\'une des chansons les plus longues et les plus difficiles à jouer en raison du grand nombre de notes (3 722 notes) et de son importante rapidite. \r\nDuree: 7.23mn', 0.5, 10, 'imgarticle\\Musiques\\throughthefireandflames.jpg'),
(19, 'One Winged Angel ', 'Square Enix', 'Nobuo Uematsu ', 'OST', '1997-10-16', 'Telechargement', 'Final Fantasy 7 OST', 'Theme mythique du combat final contre Sephiroth ! ', 0.35, 1, 'imgarticle\\Musiques\\finalfantasy7.jpg'),
(20, 'Liberi Fatali ', 'Square Enix', 'Nobuo Uematsu', 'OST', '1999-05-22', 'Telechargement', 'Final Fantasy 8 OST', 'Musique d\'ouverture de final fantasy 8. Une scene mythique pour une romance magique.', 0.25, 2, 'imgarticle\\Musiques\\finalfantasy8.jpg');
...
INSERT INTO `panier` (`IDAcheteur`, `IDArticle`, `QAchetee`) VALUES
(11111, 999, 0),
(22222, 999, 0),
(33333, 999, 0),
(44444, 999, 0),
...
INSERT INTO `sports` (`ID`, `Type`, `Objet`, `Age`, `Marque`, `Saison`, `Poids`, `Prix`, `Quantite`, `Image`) VALUES
(234, 'Fitness & Musculation', 'Roue abdominale', 16, 'Adidas', 'Year-round', 1, 14.5, 7, 'imgarticle\\Sport&Loisirs\\ROUEADBO.jpg'),
(567, 'Electronique', 'Podometre', 16, 'HETP', 'ALL', 20, 60, 2, 'imgarticle\\Sport&Loisirs\\montreconnectee.jpg');
...
INSERT INTO `vetements` (`ID`, `Sexe`, `Type`, `Couleur`, `Marque`, `Taille`, `Prix`, `Quantite`, `Image`) VALUES
(111, 'Femme', 'Robe', 'Rouge', 'Tara Jarmon', 38, 50, 2, 'imgarticle\\Vetements\\roberougefemme.jpg'),
(112, 'Femme', 'Pantalon', 'Kaki', 'ASOS', 36, 15, 4, 'imgarticle\\Vetements\\pantakifemme.jpg'),
(113, 'Homme', 'Pull, Gilet, Sweat', 'Noir', 'Tommy Hilfiger', 38, 30, 4, 'imgarticle\\Vetements\\pull-tommy-hilfigerhomme.jpg'),
(114, 'Homme', 'Chemise', 'Blanc a carreaux', 'Kuson', 42, 49, 5, 'imgarticle\\Vetements\\chemisecareauxhomme.jpg'),
(115, 'Bebe', 'Gigoteuse', 'Rayee bleu et blanc', 'Petit Bateau', 24, 55, 10, 'imgarticle\\Vetements\\gigoteuse.jpg'),
(116, 'Mixte', 'Chaussons mixte enfant', 'Rouge', 'Playshoes', 5, 14, 3, 'imgarticle\\Vetements\\chaussonsenfants.jpg');
COMMIT;
